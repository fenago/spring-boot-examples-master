...
### /src/main/java/com/fenago/springboot/configuration/BasicConfiguration.java

```java
package com.fenago.springboot.configuration;
...
### /src/main/java/com/fenago/springboot/configuration/DevelopmentOnlyConfiguration.java
...
### /src/main/java/com/fenago/springboot/configuration/ProductionOnlyConfiguration.java
...
### /src/main/java/com/fenago/springboot/jpa/User.java

```java
package com.fenago.springboot.jpa;
...
### /src/main/java/com/fenago/springboot/jpa/UserCommandLineRunner.java
...
### /src/main/java/com/fenago/springboot/jpa/UserRepository.java
...
### /src/main/java/com/fenago/springboot/jpa/UserRestRepository.java
...
public class Course {
    ...
    // Can not construct instance of com.fenago.springboot.model.Course:
...
### /src/main/java/com/fenago/springboot/StudentApplication.java
...
### /src/main/java/com/fenago/springboot/WelcomeController.java
...
import com.fenago.springboot.configuration.BasicConfiguration;
...
### /src/main/java/com/fenago/springboot/WelcomeService.java
...
basic.message=Welcome to fenago - Dev Profile
```
...
basic.value=true
basic.message=Welcome to fenago - Changed
basic.number=200
...
### /src/test/java/com/fenago/springboot/controller/StudentControllerIT.java
...
import com.fenago.springboot.StudentApplication;
import com.fenago.springboot.model.Course;
...
### /src/test/java/com/fenago/springboot/controller/StudentControllerTest.java
