...
### /src/main/java/com/fenago/springboot/jdbc/h2/example/SpringBoot2JdbcWithH2Application.java

```java
package com.fenago.springboot.jdbc.h2.example;
...
import com.fenago.springboot.jdbc.h2.example.student.Student;
import com.fenago.springboot.jdbc.h2.example.student.StudentJdbcRepository;
...
### /src/main/java/com/fenago/springboot/jdbc/h2/example/student/Student.java

```java
package com.fenago.springboot.jdbc.h2.example.student;
...
### /src/main/java/com/fenago/springboot/jdbc/h2/example/student/StudentJdbcRepository.java
...
### /src/test/java/com/fenago/springboot/jdbc/h2/example/SpringBoot2JdbcWithH2ApplicationTests.java
