<!---
Current Directory : /fenago/git/spring-boot-examples/spring-boot-tutorial-soap-web-services
-->
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <groupId>com.fenago.springboot.soap.web.services.example</groupId>
...
### /src/main/java/com/fenago/springboot/soap/web/services/example/SpringBootTutorialSoapWebServicesApplication.java

```java
package com.fenago.springboot.soap.web.services.example;
...
### /src/main/java/com/fenago/springboot/soap/web/services/example/student/Student.java
...
### /src/main/java/com/fenago/springboot/soap/web/services/example/student/StudentDetailsEndpoint.java
...
### /src/main/java/com/fenago/springboot/soap/web/services/example/WebServiceConfig.java
...
public class WebServiceConfig {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema studentsSchema) {
        ...
        definition.setTargetNamespace("http://fenago.com/students");
...
### /src/main/java/com/fenago/students/GetStudentDetailsRequest.java
...
### /src/main/java/com/fenago/students/GetStudentDetailsResponse.java
 ...
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="StudentDetails" type="{http://fenago.com/students}StudentDetails"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
### /src/main/java/com/fenago/students/ObjectFactory.java
 ...
 * generated in the com.fenago.students package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.fenago.students
     *
     */
...
### /src/main/java/com/fenago/students/package-info.java
...
@jakarta.xml.bind.annotation.XmlSchema(namespace = "http://fenago.com/students", elementFormDefault = jakarta.xml.bind.annotation.XmlNsForm.QUALIFIED)
package com.fenago.students;
```

---

### /src/main/java/com/fenago/students/StudentDetails.java
...
targetNamespace="http://fenago.com/students" 
xmlns:tns="http://fenago.com/students" elementFormDefault="qualified">
...
### /src/test/java/com/fenago/springboot/soap/web/services/example/SpringBootTutorialSoapWebServicesApplicationTests.java
