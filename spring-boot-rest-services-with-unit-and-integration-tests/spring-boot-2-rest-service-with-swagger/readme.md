...
### /src/main/java/com/fenago/springboot/rest/example/swagger/ApiDocumentationConfig.java

```java
package com.fenago.springboot.rest.example.swagger;
...
@OpenAPIDefinition(
        info = @Info(
                ...
                contact = @Contact(
                        name = "Ranga Karanam",
                        email = "ranga.karanam@fenago.com",
                        url = "http://www.fenago.com"
                ),
                license = @License(
                        name = "Apache 2.0",
        ...
        servers = {@Server(url = "http://fenago.com")}
)
...
### /src/main/java/com/fenago/springboot/rest/example/swagger/OpenApiConfig.java
    ...
    public OpenAPI springShopOpenAPI() {
        return new OpenAPI()
                ...
                .externalDocs(new ExternalDocumentation()
                        .description("Ranga Karanam, fenago@gmail.com")
                        .url("http://www.fenago.com"));
    }
